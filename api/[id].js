...
export default async function handler(req, res) {
  // Ambil ID dari req.query, pastikan aman dari nested object
  let { id } = req.query;

  // Jika id berupa array atau objek, ambil nilai string-nya
  if (Array.isArray(id)) {
    id = id[0];
  ...
  try {
    ...
    // Lakukan redirect permanen (301) atau sementara (302) ke URL tujuan
